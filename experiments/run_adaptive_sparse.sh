...
OUTPUT_DIR="${OUTPUT_DIR:-${RESULTS_DIR}/adaptive_sparse/${TASK}}"
PATCH_GRID_SIZE="${PATCH_GRID_SIZE:-20}"
MAX_HIGHRES_PATCHES="${MAX_HIGHRES_PATCHES:-80}"
...
SELECTOR_REFRESH_STRIDE="${SELECTOR_REFRESH_STRIDE:-1}"
SPARSE_GATE_MODE="${SPARSE_GATE_MODE:-auto}"
LLM_PRUNE_COUNT="${LLM_PRUNE_COUNT:-0}"
LLM_PRUNE_MIN_LAYER="${LLM_PRUNE_MIN_LAYER:-0.5}"
...
echo "======================================================"
echo "  Adaptive Sparse VLA"
echo "  gpu                 : ${GPU_ID}"
echo "  task                : ${TASK}"
echo "  n_episodes          : ${N_EPISODES}"
echo "  output_dir          : ${OUTPUT_DIR}"
echo "  patch_grid_size     : ${PATCH_GRID_SIZE}"
echo "  max_highres_patches : ${MAX_HIGHRES_PATCHES}"
echo "  patch_grasp_steps   : ${PATCH_GRASP_STEPS}"
echo "  sparse_gate_mode    : ${SPARSE_GATE_MODE}"
echo "  selector_refresh    : ${SELECTOR_REFRESH_STRIDE}"
echo "  llm_prune_count     : ${LLM_PRUNE_COUNT}"
echo "  selector_hub        : ${SELECTOR_HUB}"
echo "======================================================"
