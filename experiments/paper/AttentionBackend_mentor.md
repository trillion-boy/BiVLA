<!-- The mentor's attention-backend note, received 2026-09-08 as attention_backend.md, unchanged below. Covers SpatialVLA, CogACT, CronusVLA, MiniVLA, SmolVLA; OpenVLA and UniVLA are not covered (the exported harnesses request sdpa: tricks/scripts/benchmark_openvla_14.py 159, adaptive_sparse_vla/inference.py 796; the OpenVLA LIBERO loader adaptive_sparse_vla/inference_openvla_libero.py 122 defaults to eager). Source for the Setup IV-A backend lines. -->
