...
1. **GPU cards** (Section 1.6). The paper says "a system equipped with 4x RTX 5090 GPUs". The records name a card only for the three reruns (RTX 5090) and the SmolVLA re-implemented rows; the SmolVLA depth-pruning 2- and 4-layer partial reruns record RTX 5090, RTX PRO 6000, RTX 6000 Ada, L40S and RTX A6000. The page lists these as recorded. If this should not be public, delete the "GPU cards" table and keep the sentence about RTX 5090 nodes.
