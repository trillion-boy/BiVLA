...
UniVLA, foveation. Tables~\ref{tab:simplerenv-results} and~\ref{tab:libero-results} say
the same, where no green success cell exceeds 10 points while red cells
of 10 points or more appear in every environment. Of the 110 best-setting cells, 22
lower success significantly and four raise it, and the four gains, on
CogACT WidowX, OpenVLA Fractal and UniVLA Goal, are each under 10 points and
none survives the false discovery rate correction of Section~IV-A, while
most of the drops exceed 10 points. Over all 286 settings six gains pass
against about four expected by chance, and three of the four table gains
sit on CogACT WidowX and OpenVLA Fractal, the two pairs whose every depth
and fusion setting rises, which the seeds of Section~V should test.
% 2026-09-15: exact McNemar sizes summed over the 286 rows give 7.9 expected passes (4.0 per direction), over the 110 cells 3.1; all six depth and fusion settings are positive on exactly two pairs, CogACT WidowX and OpenVLA Fractal, which carry three of the four table gains.
Guarded reuse and temporal
...
leave it intact in every table cell, and foveation, action repeat and
depth pruning each cost success on about half of the backbones at their
mildest setting and on more at stronger ones.}

\textbf{RQ-2.} In Fig.~\ref{fig:tradeoff-widowx} the shaded corner,
faster beyond the latency floor and no worse, is empty on SpatialVLA and UniVLA and holds at most
...
success significantly on 8, and four layers are faster on 18 of the 19 pairs whose latency is
read and cost success on 14. Four of the drops at each budget are
SmolVLA's, whose removed layers were fixed rather than chosen by Block
Influence (Section~IV-A).
% 2026-09-15: depth-4 speedup read on 19 pairs (SmolVLA Long, Goal, Object excluded, reconstructed stack), 18 beyond the 1.6 percent floor; SmolVLA is 4 of 8 significant drops at one layer and 4 of 14 at four.
Guarded reuse saves time only where its gates open, a
...
and UniVLA. We therefore keep the fire count of every run with its paired records
and recommend reporting it for any gated trick. Cells on CogACT, CronusVLA, MiniVLA and
