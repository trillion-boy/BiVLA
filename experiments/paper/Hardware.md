...
|---|---|---|
| 7,198 episodes under `results/` | 7198 | ✓ as an archive count. The paper reports the **campaign's 6,910** instead, which drops the 384 June LatentSaccade episodes and adds the 96-episode imported foveation cell (`EpisodeCounts.md` §5--6) |
