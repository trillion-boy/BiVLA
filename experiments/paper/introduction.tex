...
(Sec.~\ref{sec:setup}).\footnote{Model time only, excluding simulator stepping.
We report it as a scale, not as a benchmark: the GPU model was not recorded in
our result files, which is a limitation we return to in
