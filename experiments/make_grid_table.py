...
\begin{table*}[t]
\centering
\caption{Every condition in the grid, as the paired change in success points
against that cell's own baseline. A cell pairs only the episodes present in
