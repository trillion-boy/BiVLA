...
> | `Report.md` | 어떻게 쟀고(§3) 무엇이 나왔고(§4–6) 무엇이 남았나(§7) | ~2,190줄 |
...
| 검증 | 문서의 숫자를 전부 기록에서 재계산해 대조 — **일치. 대조 과정에서 나온 불일치는 70건이고 전부 고쳤다**(`Report.md` §7.1) |
| baseline | 다섯 칸 전부 원논문 값과 대조 — **어디서도 낮지 않음** |
| 선행연구 | **7편** 원문 PDF 대조 완료 (표 안 숫자까지) |
...
|---|---|---|---|
| 분량 | ~460줄 | ~2,190줄 | ~1,230줄 |
| 목적 | **10분에 파악** | 근거·검증·기록 | 남이 잰 것 |
| 안에 있는 것 | 결과 셋과 현황 | 모든 표, 정정 기록 70건, 기계 검증 | §2 선행연구 + 논문별 노트 7편 |
