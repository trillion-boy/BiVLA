...
> | 문서 | 무엇 | 분량 |
> |---|---|---|
> | **이 문서** | **연구 전체를 10분에** | ~340줄 |
> | `Report.md` | 어떻게 쟀고(§3) 무엇이 나왔고(§4–6) 무엇이 남았나(§7) | ~1,980줄 |
...
|---|---:|---:|---:|
| 1–2 px (한가운데) | 49 | 1 | **0.02** ← 1픽셀이 49열로 퍼짐 |
| 64–128 px | 74 | 64 | 0.86 |
| 256–400 px (가장자리) | 47 | 144 | **3.06** ← 3픽셀이 1열로 뭉개짐 |

**가운데는 잔뜩 확대되고, 가장자리는 3픽셀이 1칸에 눌려 담긴다. 눌려서 없어진
건 되돌려도 안 살아난다.** 그래서 왕복만 해도 이미 "가운데 또렷, 바깥 흐릿"이
...
| **전체가 고르게 열화** | 솎아내기 (keep 낮출수록 커짐) | 해 |
